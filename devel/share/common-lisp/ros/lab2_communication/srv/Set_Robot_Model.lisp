...
(cl:in-package lab2_communication-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Set_Robot_Model-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Set_Robot_Model-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab2_communication-srv:<Set_Robot_Model-request> is deprecated: use lab2_communication-srv:Set_Robot_Model-request instead.")))

(cl:ensure-generic-function 'model-val :lambda-list '(m))
(cl:defmethod model-val ((m <Set_Robot_Model-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab2_communication-srv:model-val is deprecated.  Use lab2_communication-srv:model instead.")
  (model m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Set_Robot_Model-request>)))
  ...
  "lab2_communication/Set_Robot_ModelRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Set_Robot_Model-request)))
  "Returns string type for a service object of type 'Set_Robot_Model-request"
  "lab2_communication/Set_Robot_ModelRequest")
...
(cl:defclass <Set_Robot_Model-response> (roslisp-msg-protocol:ros-message)
  ((robotID
    :reader robotID
    :initarg :robotID
    :type lab2_communication-msg:robot_id
    :initform (cl:make-instance 'lab2_communication-msg:robot_id)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Set_Robot_Model-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Set_Robot_Model-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab2_communication-srv:<Set_Robot_Model-response> is deprecated: use lab2_communication-srv:Set_Robot_Model-response instead.")))

(cl:ensure-generic-function 'robotID-val :lambda-list '(m))
(cl:defmethod robotID-val ((m <Set_Robot_Model-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab2_communication-srv:robotID-val is deprecated.  Use lab2_communication-srv:robotID instead.")
  (robotID m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Set_Robot_Model-response>)))
  ...
  "lab2_communication/Set_Robot_ModelResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Set_Robot_Model-response)))
  "Returns string type for a service object of type 'Set_Robot_Model-response"
  "lab2_communication/Set_Robot_ModelResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Set_Robot_Model-response>)))
  ...
  (cl:format cl:nil "lab2_communication/robot_id robotID~%~%================================================================================~%MSG: lab2_communication/robot_id~%Header header~%int8 id~%string model~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Set_Robot_Model-response)))
  "Returns full string definition for message of type 'Set_Robot_Model-response"
  (cl:format cl:nil "lab2_communication/robot_id robotID~%~%================================================================================~%MSG: lab2_communication/robot_id~%Header header~%int8 id~%string model~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Set_Robot_Model)))
  ...
  "lab2_communication/Set_Robot_Model")