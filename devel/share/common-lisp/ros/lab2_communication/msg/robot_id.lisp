...
(cl:in-package lab2_communication-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <robot_id>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_id)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab2_communication-msg:<robot_id> is deprecated: use lab2_communication-msg:robot_id instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <robot_id>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab2_communication-msg:header-val is deprecated.  Use lab2_communication-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <robot_id>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab2_communication-msg:id-val is deprecated.  Use lab2_communication-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'model-val :lambda-list '(m))
(cl:defmethod model-val ((m <robot_id>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab2_communication-msg:model-val is deprecated.  Use lab2_communication-msg:model instead.")
  (model m))
