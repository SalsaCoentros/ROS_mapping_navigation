...
class DoInverseKinematicsRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DoInverseKinematicsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DoInverseKinematicsRequest
    let len;
    let data = new DoInverseKinematicsRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DoInverseKinematicsRequest(null);
...
class DoInverseKinematicsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.Joints = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DoInverseKinematicsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DoInverseKinematicsResponse
    let len;
    let data = new DoInverseKinematicsResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DoInverseKinematicsResponse(null);
...
module.exports = {
  Request: DoInverseKinematicsRequest,
  Response: DoInverseKinematicsResponse,
  md5sum() { return '2f2254e383e50f68fbb62f9a1189526d'; },
  datatype() { return 'tr5_kinematics/DoInverseKinematics'; }
};
